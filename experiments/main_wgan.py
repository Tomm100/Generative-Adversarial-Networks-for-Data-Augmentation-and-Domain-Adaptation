...
# Root del repo nel path: consente l'esecuzione da experiments/ (python experiments/main_wgan.py)
import sys
...
from training.train import train_resnet, train_wgangp
from evaluation.eval import evaluate_on_test, generate_synthetic_images, plot_comparison

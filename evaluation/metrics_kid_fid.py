...
# SNGAN 128 PG+BG (generatore SNGAN, models.sngan_128)
...
def main():
    global Generator
    parser = argparse.ArgumentParser(description="FID/KID nel tempo su checkpoint SNGAN.")
    parser.add_argument("--ckpt-dir",
                        default='/content/drive/MyDrive/ProgettoMLVM/results_new_SNGAN_pg_bg_128/sngan_checkpoints/',
                        help="Cartella con i G_epoch_*.pth da valutare.")
    parser.add_argument("--gan", choices=["sngan128", "sngan256", "wgan"], default="sngan128",
                        help="Architettura del generatore per caricare i checkpoint (default: sngan128).")
    args = parser.parse_args()

    # Override del generatore se richiesto (default sngan128 = gia' importato in cima)
    if args.gan == "wgan":
        from models.wgan import Generator
    elif args.gan == "sngan256":
        from models.sngan import SNGenerator as Generator

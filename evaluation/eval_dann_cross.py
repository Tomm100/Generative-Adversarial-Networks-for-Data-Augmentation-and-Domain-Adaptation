...
Uso:  python evaluation/eval_dann_cross.py --ckpt /percorso/best_DANN_lam1.pth
"""
...
def main():
    global CKPT_PATH, CKPT_LABEL
    parser = argparse.ArgumentParser(description="Valutazione DANN cross-hospital su piu' test set.")
    parser.add_argument("--ckpt", default=CKPT_PATH, help="Percorso pesi DANN (.pth).")
    parser.add_argument("--label", default=CKPT_LABEL, help="Etichetta leggibile del checkpoint.")

...
class SNCritic(nn.Module):
    """PatchGAN Critic 128x128 condizionale con Spectral Normalization. Output: griglia 16x16."""
...
class SNCriticNoPG(nn.Module):
    """Standard DCGAN Critic 128x128 condizionale con Spectral Normalization (senza PatchGAN). Output: scalare 1x1."""
    def __init__(self, nc=1, n_class=2, d=128):
        super().__init__()
        self.conv1 = spectral_norm(nn.Conv2d(nc + n_class, d, 4, 2, 1))
        self.conv2 = spectral_norm(nn.Conv2d(d, d * 2, 4, 2, 1))
